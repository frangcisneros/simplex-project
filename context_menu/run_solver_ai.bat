@echo off
:: Wrapper batch para resolver problemas con IA desde el menú contextual.
...
set "PYTHON_SCRIPT=%SCRIPT_DIR%solve_from_context_ai.py"  # Ruta al script de Python para resolver con IA.

:: Verificar que existe el script de Python
if not exist "%PYTHON_SCRIPT%" (
    echo ERROR: No se encontro el script solve_from_context_ai.py  # Asegura que el script de Python requerido exista.
